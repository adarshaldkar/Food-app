...
router.route("/all").get(restaurant_controller_1.getAllRestaurants);
...
router.route("/fix-duplicates").post(restaurant_controller_1.fixDuplicateRestaurants); // Admin cleanup route
